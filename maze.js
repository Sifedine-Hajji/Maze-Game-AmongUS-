...
function movetop() {
  ...
  if (
    document
      .querySelector("body > main > div div:nth-child(" + play + ")")
      .classList.contains("chemins")
  ) {
    playerpos = play;

    document
      .querySelector("body > main > div div:nth-child(" + playerpos + ")")
      .appendChild(player);
  } else {
...
let playerpos = 15;
document
  .querySelector("body > main > div > div:nth-child(49)")
  .appendChild(imposteur);
let impostorpos = 49;
...
document.body.addEventListener("keyup", function (e) {
  ...
  if (playerpos == 26) {
    main.innerHTML =
      "<video autoplay muted><source src='./vids/Emergency.mp4' type='video/mp4' /></video>";
    setTimeout(function () {
      document.querySelector(
        "body > main > video"
      ).style.display = location.reload();
    }, 2000);
  }
  if (playerpos == impostorpos) {
    main.innerHTML =
      "<video autoplay muted><source src='./vids/red-kill-white.mp4' type='video/mp4' /></video>";
    setTimeout(function () {
      document.querySelector(
        "body > main > video"
      ).style.display = location.reload();
